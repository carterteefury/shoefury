/** 
* Copyright 2008-2011 massimocorner.com
...
// We are the first document in the chain
  ...
  */  
  tmt.jquery.modalframe.getInstance = function(url, options){
    ...
    var retObj = {};
    var iframeNode = jQuery('<iframe scrolling="no" frameborder="0" id="' + frameName + '" name="' + frameName + '" class="tmtModalFrame" style="display: none" src="' + url + '"></iframe>');
