...
ActiveRecord::Schema.define(:version => 20120528134434) do
  ...
  create_table "spree_address_entries", :force => true do |t|
    t.string   "name"
    t.integer  "user_id"
  ...
  create_table "spree_brands", :force => true do |t|
    ...
    t.string   "sizing_chart_file_name"
    t.string   "sizing_chart_content_type"
    t.integer  "sizing_chart_file_size"
    t.datetime "sizing_chart_updated_at"
    t.text     "about"
    t.string   "background_color"
    t.string   "primary_text_color"
    t.string   "secondary_text_color"
    t.string   "link_color"
    t.boolean  "dark_color_scheme"
    t.text     "return_policy"
    t.integer  "return_days",               :default => 0
  ...
  create_table "spree_hearts", :force => true do |t|
  ...
  add_index "spree_hearts", ["product_id", "user_id"], :name => "index_spree_hearts_on_product_id_and_user_id", :unique => true
  ...
  add_index "spree_products", ["brand_id"], :name => "index_spree_products_on_brand_id"
  add_index "spree_products", ["created_at"], :name => "index_spree_products_on_created_at"
  add_index "spree_products", ["deleted_at"], :name => "index_products_on_deleted_at"
  add_index "spree_products", ["hearts_count"], :name => "index_spree_products_on_hearts_count"
